...
class VilfredoMesosScheduler(Scheduler):
    def __init__(self, paretoExecutor, updateDurationsFilename):
        ...
        self.updateDurationsFilename = updateDurationsFilename
    ...
    def statusUpdate(self, driver, update):
        ...
        print "{}: Task [{}] on slave {} is in state [{}]".format(
            self.now(), taskID, slaveID, stateName)
    ...
    def frameworkMessage(self, driver, executorId, slaveId, message):
        ...
        print "{}: Message from {} on slave {}".format(
            self.now(), executorId.value, slaveId.value)
...
if __name__ == "__main__":
    ...
    if credential is None:
        ...
        driver = MesosSchedulerDriver(vilfredo, framework, sys.argv[1], credential)
